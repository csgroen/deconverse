...
```{r results='hide'}
download.file("https://xfer.curie.fr/get/nil/GV9gQQ8g4qh/scref_cache.zip", "scref_cache.zip")
...
```{r results='hide'}
download.file("https://xfer.curie.fr/get/nil/F7oxfkXO5aq/scbench_cache.zip", "scbench_cache.zip")
